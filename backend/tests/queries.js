...
const GROUPS_THAT_USER_CAN_JOIN = gql`
query{
  me{
    groupsUserCanJoin{
      name
...
mutation sendGroupMessage($group: String!, $message: String!){
  sendGroupMessage(group: $group, message: $message){
    content
  }
}`

module.exports = { ADD_EVENT, LOGIN, ADD_GROUP, ME, USER_GROUPS, USER_EVENTS, GET_EVENT, VOTE_EVENT, JOIN_GROUP, GROUPS_THAT_USER_CAN_JOIN, LEAVE_GROUP, DELETE_EVENT, USER_MESSAGES, ADD_TO_ADMINS, REMOVE_FROM_GROUP, JOIN_REQUEST, GET_MESSAGE, READ_MESSAGE, UNREAD_MESSAGES, SEND_USER_MESSAGE, DELETE_MESSAGE, SEND_GROUP_MESSAGE }
